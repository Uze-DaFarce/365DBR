...
const vids = ["SNG.4.1", "2CO.4.1"];
const sections = [[], [], [], []];
vids.forEach(vid => sections[getSectionIndex(vid)].push(vid));

console.log("SNG Section Index:", getSectionIndex("SNG.4.1"));
