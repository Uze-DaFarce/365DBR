...
class EggZamRoom extends Phaser.Scene {
  ...
  create() {
    ...
    const btnScale = this.gameScale * 0.4;
    const centerBottomX = width / 2;
    const centerBottomY = height - (100 * this.gameScale);

    const buttonSpacing = 120 * this.gameScale;
    ...
    if (typeof addTooltip === 'function') addTooltip(this, stinkyBtn, 'Categorize as Eggs-tra Stinky');
    ...
    if (typeof addTooltip === 'function') addTooltip(this, eggCellentBtn, 'Categorize as Egg-cellent');
  ...
  displayRandomEggInfo() {
    ...
    if (this.currentEgg) {
      ...
      const offsetX = (width - (1168 * coverScale)) / 2;
