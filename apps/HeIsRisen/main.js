...
class CursorScene extends Phaser.Scene {
  ...
  create() {
    ...
    const handleCursorResize = (gameSize) => {
    ...
    this.scale.on('resize', handleCursorResize);
    this.events.once('shutdown', () => {
        this.scale.off('resize', handleCursorResize);
    });
  }
...
class EggZamRoom extends Phaser.Scene {
  ...
  create() {
    ...
    const handleEggZamResize = () => {
        this.scene.restart(); // Simplest way to handle resizing complex UI layouts
    };
    this.scale.on('resize', handleEggZamResize);
    this.events.once('shutdown', () => {
        this.scale.off('resize', handleEggZamResize);
    });
  }
