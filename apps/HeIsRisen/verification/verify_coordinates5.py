...
async def main():
    ...
    async with async_playwright() as p:
        ...
        await page.screenshot(path="apps/HeIsRisen/verification/mobile_final_eggzam.png")
        ...
        await page2.wait_for_timeout(2000)
        await page2.screenshot(path="apps/HeIsRisen/verification/desktop_final_eggzam.png")

        # DESKTOP CAT
        await page2.evaluate("""() => {
            const registry = window.game.registry;
            let foundEggs = [];
            foundEggs.push({ eggId: 1, x: 0, y: 0, section: 'a' });
            registry.set('foundEggs', foundEggs);
        ...
        await page2.wait_for_timeout(2000)
        await page2.screenshot(path="apps/HeIsRisen/verification/desktop_cat_egg_o_rise.png")
        ...
        await page.wait_for_timeout(2000)
        await page.screenshot(path="apps/HeIsRisen/verification/mobile_cat_egg_o_rise.png")
