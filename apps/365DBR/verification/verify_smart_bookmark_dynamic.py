...
def run(source: str):
    ...
    with sync_playwright() as p:
        ...
        page.goto("https://mt-sin.ai/365DBR/index.html", wait_until="networkidle")
        ...
        try:
            ...
            page.goto(f"https://mt-sin.ai/365DBR/index.html?startDate={tomorrow_mmdd}", wait_until="networkidle")
            ...
            page.goto(f"https://mt-sin.ai/365DBR/index.html?startDate={future_mmdd}", wait_until="networkidle")
