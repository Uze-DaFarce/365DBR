...
def run(source: str):
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page.goto("https://mt-sin.ai/365DBR/index.html?startDate=0202", wait_until="networkidle")
            ...
            page.goto("https://mt-sin.ai/365DBR/bible.html?book=EXO&chapter=9", wait_until="networkidle")
