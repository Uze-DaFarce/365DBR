...
# Hebrew/Greek/LSB Unified Verse Counts (Highest known verse per chapter)
BIBLE_DATA = {
  "GEN": [31, 25, 24, 26, 32, 22, 24, 22, 29, 32, 32, 20, 18, 24, 21, 16, 27, 33, 38, 18, 34, 24, 20, 67, 34, 35, 46, 22, 35, 43, 55, 33, 20, 31, 29, 43, 36, 30, 23, 23, 57, 38, 34, 34, 28, 34, 31, 22, 33, 26],
  "EXO": [22, 25, 22, 31, 23, 30, 29, 32, 35, 29, 10, 51, 22, 31, 27, 36, 16, 27, 25, 26, 37, 31, 33, 18, 40, 37, 21, 43, 46, 38, 18, 35, 23, 35, 35, 38, 29, 31, 43, 38],
  "LEV": [17, 16, 17, 35, 26, 30, 38, 36, 24, 20, 47, 8, 59, 57, 33, 34, 16, 30, 37, 27, 24, 33, 44, 23, 55, 46, 34],
  "NUM": [54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 16, 33, 45, 41, 50, 28, 32, 22, 29, 35, 41, 30, 25, 19, 65, 23, 31, 40, 17, 54, 42, 56, 29, 34, 13],
  "DEU": [46, 37, 29, 49, 33, 25, 26, 20, 29, 22, 32, 32, 19, 29, 23, 22, 20, 22, 21, 20, 23, 30, 26, 22, 19, 19, 26, 69, 29, 20, 30, 52, 29, 12],
  ...
  "RUT": [22, 23, 18, 22],
  "1SA": [28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24, 42, 16, 23, 29, 23, 44, 25, 12, 25, 11, 31, 13],
  "2SA": [27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37, 23, 29, 33, 44, 26, 22, 51, 39, 25],
  "1KI": [53, 46, 28, 34, 32, 38, 51, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 43, 29, 54],
  "2KI": [18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 22, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30],
  "1CH": [54, 55, 24, 43, 41, 81, 40, 40, 44, 14, 47, 41, 14, 17, 29, 43, 27, 17, 19, 8, 30, 19, 32, 31, 31, 32, 34, 21, 30],
  "2CH": [18, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 23, 15, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 33, 25, 33, 27, 23],
  "EZR": [11, 70, 13, 24, 17, 22, 28, 36, 15, 44],
  "NEH": [11, 20, 38, 23, 19, 19, 73, 18, 38, 40, 36, 47, 31],
  "EST": [22, 23, 15, 17, 14, 14, 10, 17, 32, 3],
  "JOB": [22, 13, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25, 28, 22, 35, 22, 16, 21, 29, 29, 34, 30, 17, 25, 6, 14, 23, 28, 25, 31, 40, 22, 33, 37, 16, 33, 24, 41, 30, 32, 34, 17],
  ...
  "ECC": [18, 26, 22, 17, 20, 12, 29, 17, 18, 20, 10, 14],
  "SNG": [17, 17, 11, 16, 16, 13, 14, 14],
  "ISA": [31, 22, 26, 6, 30, 13, 25, 23, 21, 34, 16, 6, 22, 32, 9, 14, 14, 7, 25, 6, 17, 25, 18, 23, 12, 21, 13, 29, 24, 33, 9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29, 25, 28, 28, 25, 13, 15, 22, 26, 11, 23, 15, 12, 17, 13, 12, 21, 14, 21, 22, 11, 12, 19, 12, 25, 24],
  "JER": [19, 37, 25, 31, 31, 30, 34, 23, 26, 25, 23, 17, 27, 22, 21, 21, 27, 23, 15, 18, 14, 30, 40, 10, 38, 24, 22, 17, 32, 24, 40, 44, 26, 22, 19, 32, 21, 28, 18, 16, 18, 22, 13, 30, 5, 28, 7, 47, 39, 46, 64, 34],
  "LAM": [22, 22, 66, 22, 22],
  "EZK": [28, 10, 27, 17, 17, 14, 27, 18, 11, 22, 25, 28, 23, 23, 8, 63, 24, 32, 14, 49, 37, 31, 49, 27, 17, 21, 36, 26, 21, 26, 18, 32, 33, 31, 15, 38, 28, 23, 29, 49, 26, 20, 27, 31, 25, 24, 23, 35],
  "DAN": [21, 49, 33, 37, 31, 29, 28, 27, 27, 21, 45, 13],
  "HOS": [11, 25, 5, 19, 15, 11, 16, 14, 17, 15, 12, 15, 16, 10],
  "JOL": [20, 32, 21, 21],
  "AMO": [15, 16, 15, 13, 27, 14, 17, 14, 15],
  "OBA": [21],
  "JON": [17, 11, 10, 11],
  "MIC": [16, 13, 12, 14, 15, 16, 20],
  "NAM": [15, 14, 19],
  "HAB": [17, 20, 19],
  "ZEP": [18, 15, 20],
  "HAG": [15, 23],
  "ZEC": [21, 17, 10, 14, 11, 15, 14, 23, 17, 12, 17, 14, 9, 21],
  "MAL": [14, 17, 24],
  ...
  # Acts ch8 = 40 under TR/KJV (includes 8:37); critical texts often list 39 without 8:37.
