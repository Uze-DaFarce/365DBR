...
# English Protestant verse counts (LSB / KJV / LSV numbering).
# User-facing BCV for bible.html picker and the reading plan.
# Do not inflate to Hebrew/Greek chapter maxima; originals attach via verseOrgIds.
BIBLE_DATA = {
  ...
  # Joel: English 3 ch (Hebrew 3–4 = Eng 2:28–3:21). verification/EDGE_CASES.md
  "JOL": [20, 32, 21],
  ...
  # Malachi: English 4 ch (Hebrew 3:19–24 = Eng 4:1–6).
  "MAL": [14, 17, 18, 6],
  ...
  # Romans: TR/KJV/GRCTR (ch14 ends at 23; doxology 16:25-27; includes 16:24).
