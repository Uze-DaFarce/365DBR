...
def run_test():
    ...
    try:
        with sync_playwright() as p:
            ...
            # Inject a mock function and directly call the internal popup logic
            # to simulate clicking an egg and opening the bible frame
            page.evaluate("""() => {
            ...
            page.screenshot(path="tests/desktop_iframe_scroll.png")
            ...
            mobile_page.screenshot(path="tests/mobile_iframe_scroll.png")
